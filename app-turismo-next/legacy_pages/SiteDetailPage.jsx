      ...
      <div className="site-detail-container">
        <div className="site-detail-header-actions">
          ...
          {currentUser && currentUser.role === 'admin' && (
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#007bff', display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.9rem' }}
            >
              <Edit size={16} /> Editar
            </button>
          )}
        ...
        <div className="site-actions-container">
          <div className="action-group">
            <button onClick={() => router.push('/mapa?siteId=' + site.id)} className="action-button map-button">
              <Map /> Ver en Mapa
            </button>
              ...
              <div className="action-group social-group">
                {site.website && (
                  <a href={site.website} target="_blank" rel="noopener noreferrer" className="action-button social-icon website-button" aria-label="Sitio Web">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="action-icon"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
                  </a>
                )}
                {site.whatsapp && (
                  <button
                ...
                {site.youtube && (
                  <a href={site.youtube} target="_blank" rel="noopener noreferrer" className="action-button social-icon youtube-button" aria-label="YouTube">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="action-icon" viewBox="0 0 16 16"><path d="M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 0 1 1.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082 2.06l-.008.105-.009.104c-.05.572-.124 1.14-.235 1.558a2.007 2.007 0 0 1-1.415 1.42c-1.16.312-5.569.334-6.18.335h-.142c-.309 0-1.587-.006-2.927-.052l-.17-.006-.087-.004-.171-.007-.171-.007c-1.11-.049-2.167-.128-2.654-.26a2.007 2.007 0 0 1-1.415-1.419c-.111-.417-.185-.986-.235-1.558L.09 9.82l-.008-.104A31.4 31.4 0 0 1 0 7.68v-.123c.002-.215.01-.958.064-1.778l.007-.103.003-.052.008-.104.022-.26.01-.104c.048-.519.119-1.023.22-1.402a2.007 2.007 0 0 1 1.415-1.42c.487-.13 1.544-.21 2.654-.26l.17-.007.172-.006.086-.003.171-.007A99.788 99.788 0 0 1 7.858 2h.193zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z" /></svg>
                  </a>
                )}
              </div>
            </div>
