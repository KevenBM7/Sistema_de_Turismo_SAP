...
function HistoryPage() {
  ...
  const TabButton = ({ tabId, children }) => <button onClick={() => setActiveTab(tabId)} className={activeTab === tabId ? 'active' : ''}>{children}</button>;

  return (
    <div className="info-page-container">
      {/* --- SEO para la Página de Historia --- */}
      <SEO 
        title="Historia y Cultura de San Antonio Palopó"
        description="Una vista profunda a nuestras raíces kaqchikeles, tradiciones milenarias y evolución a orillas del Lago de Atitlán."
        url="/historia"
        type="article"
        keywords="historia, cultura, kaqchikel, san antonio palopó, tradiciones, traje típico, cerámica"
      />
      ...
      <div className="info-page-tabs">
        <TabButton tabId="historia">Historia</TabButton>
        <TabButton tabId="cultura">Cultura y Tradiciones</TabButton>
        <TabButton tabId="economia">Economía y Territorio</TabButton>
        <TabButton tabId="gobierno">Gobierno Actual</TabButton>
      </div>
        ...
        {activeTab === 'historia' && (
          <>
            <section className="info-page-section">
              ...
              <img
                src="https://firebasestorage.googleapis.com/v0/b/turismo-municipal.firebasestorage.app/o/staticpages%2Fhistory%2FDescubriento%20nuestra%20Historia%20San%20Antonio%20Palop%C3%B3%20Solol%C3%A1.webp?alt=media&token=bc390a10-7089-4f7f-973c-949b036dd6fb"
                alt="Historia de San Antonio Palopó"
        ...
        {activeTab === 'cultura' && (
          <>
            <section className="info-page-section">
              ...
              <img
                src="https://firebasestorage.googleapis.com/v0/b/turismo-municipal.firebasestorage.app/o/staticpages%2Fhistory%2FTraje%20t%C3%ADpico%20de%20san%20antonio%20palop%C3%B3.webp?alt=media&token=62de36dc-124e-4e29-812e-e85032793789"
        ...
        {activeTab === 'economia' && (
          <>
            <section className="info-page-section">
              ...
              <img
                src="https://firebasestorage.googleapis.com/v0/b/turismo-municipal.firebasestorage.app/o/staticpages%2Fhistory%2Figlesia%20cat%C3%B3lica%20san%20antonio%20palop%C3%B3%20a%20orillas%20del%20hermoso%20lago%20de%20atitl%C3%A1n.webp?alt=media&token=3880e079-3169-49e1-b206-6aa3e9e97639"
                alt="Economía de San Antonio Palopó"
                className="info-page-image"
              />
        ...
        {activeTab === 'gobierno' && (
          <>
            <section className="info-page-section">
              ...
              <p className="info-page-section-subtitle">Información sobre la administración y estructura del gobierno local.</p>
              ...
              <p>
                ...
                y la recuperación de la cinta asfáltica que comunica con Santa Catarina Palopó.<br />

                Para más información sobre la gestión municipal, visite: <a href="https://municipalidadsanantoniopalopo.com/" target="_blank" rel="noopener noreferrer">Municipalidad de San Antonio Palopó</a>
              </p>
